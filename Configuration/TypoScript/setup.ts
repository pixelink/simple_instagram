...
plugin.tx_simpleinstagram_instafeed {
    ...
    persistence {
        storagePid = {$plugin.tx_simpleinstagram_instafeed.persistence.storagePid}
        #recursive = 1
    }
    features {
...
plugin.tx_simpleinstagram._CSS_DEFAULT_STYLE (
    ...
    .tx-simple-instagram table {
        border-collapse:separate;
        border-spacing:10px;
    }

    .tx-simple-instagram table th {
        font-weight:bold;
    }

    .tx-simple-instagram table td {
        vertical-align:top;
    }
